...
<!--
  ...
  Date: 2026-02-25
  Notes:
    - This is the Land listings page for Horizon Realty.
-->
...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Horizon Realty - Land for sale.">
    <meta name="keywords" content="land for sale, real estate land, Horizon Realty">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="icon" href="media/favicon.ico">
    <title>Horizon Realty - Land</title>
            ...
            <ul class="nav-menu">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-content" aria-label="Listing categories">
                        ...
                        <li><a href="land.php" class="active">LAND</a></li>
