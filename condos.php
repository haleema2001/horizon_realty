...
<!--
  ...
  Date: 2026-03-26
  Notes:
    - This is the Condos listings page for Horizon Realty.
-->
...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Horizon Realty - Condos for sale.">
    <meta name="keywords" content="condos for sale, condos, Horizon Realty">
            ...
            <ul class="nav-menu">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-content" aria-label="Listing categories">
                        ...
                        <li><a href="condos.php" class="active">CONDOS</a></li>
