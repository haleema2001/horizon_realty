...
<!--
  ...
  Date: 2026-02-25
  Notes:
    - This is the Vacation Properties listings page for Horizon Realty.
-->
...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Horizon Realty - Vacation properties for sale.">
    <meta name="keywords" content="vacation properties, cottages, getaway homes, Horizon Realty">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="icon" href="media/favicon.ico">
    <title>Horizon Realty - Vacation Properties</title>
            ...
            <ul class="nav-menu">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-content" aria-label="Listing categories">
                        ...
                        <li><a href="vacation-properties.php" class="active">VACATION</a></li>
