...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Horizon Realty - Luxury estates for sale.">
    <meta name="keywords" content="luxury estates, luxury homes, real estate, Horizon Realty">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="icon" href="media/favicon.ico">
    <title>Horizon Realty - Luxury Estates</title>
            ...
            <ul class="nav-menu">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-content" aria-label="Listing categories">
                        ...
                        <li><a href="luxury-estates.php" class="active">LUXURY ESTATES</a></li>
